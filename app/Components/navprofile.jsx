        ...
        <nav className="flex w-screen border-b drop-shadow-md fixed py-2 bg-[var(--oxford-blue)] z-999 md:h-1/11">
            ...
            <div className="flex justify-end w-full">
                {isLogin ? UserMenuContent() :
                    <div className="px-4 flex content-center place-items-center gap-3">
                        <Link href='/auth/login' className="rounded-xl bg-[var(--yale-blue)] px-5 py-3 hover:scale-105 ease-in-out duration-100">Login</Link>
                        <Link href='/auth/register' className="rounded-xl bg-[var(--gold)] px-3 py-3 text-black hover:scale-105 ease-in-out duration-100 ">Register</Link>
                    </div>
                }
            </div>
        </nav>
